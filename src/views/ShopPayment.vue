    ...
    <div class="pay">
        ...
        <div class="pay-card">
            ...
            <div class="pay-txt">
                ...
                <div class="card">
                    <input type="text" name="month" placeholder="MM" maxlength="2" class="pay-input">
                    <span class="slash">/</span>
                    <input type="text" name="year" placeholder="YY" maxlength="2" class="pay-input">
                </div>
            </div>
            <div class="pay-txt">
                ...
                <div>
                    <div class="card">
                        <input type="text" name="code" placeholder="XXX" maxlength="3" class="pay-input">
                    </div>
